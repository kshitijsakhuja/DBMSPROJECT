  ...
  <body onload="onload()">
    ...
    <section class="home-section">
      ...
      <div class="home-content">
              ...
              <div class="main ">
                <div class="main-head">
            <h2>സ്പെഷ്യലൈസേഷനുകൾ</h2><br><hr><br><br>
            <a href="add-specialization.html"><button><i class="fa-solid fa-plus"></i>സ്പെഷ്യലൈസേഷൻ ചേർക്കുക</button></a>
            </div>
...
<table>
  <tr>
      <th>ഐഡി</th>
      <th>സ്പെഷ്യലൈസേഷൻ</th>
      <th>ഉണ്ടാക്കിയ തിയതി</th>
      <th>അപ്ഡേറ്റ് തീയതി</th>
      <th>നടപടി</th>
    </tr>
  <!-- <tr>
    <tr>
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>
                <a href='delete_specia.php? deleteid=".$row['id']."'> 
